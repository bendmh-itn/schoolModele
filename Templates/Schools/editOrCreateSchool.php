...
<form method="post" action="">
    <fieldset>
        ...
        <div class="mb-3">
            ...
            <input type="text" placeholder="Nom" class="form-control" id="Nom" name="nom" value="<?php if (isset($school)) : ?><?= $school->schoolNom ?><?php endif ?>">
        ...
        <div class="mb-3">
            ...
            <select name="options[]" id="options-select" multiple>
                <?php foreach ($options as $option) : ?>
                    <option value="<?= $option->optionScolaireId ?>" <?php if (isset($optionsSchool)) : ?><?php foreach ($optionsSchool as $optionSchool) : ?><?php if ($option->optionScolaireId === $optionSchool->optionScolaireId) : ?>selected<?php endif ?><?php endforeach ?><?php endif ?>><?= $option->nom ?></option>
                <?php endforeach ?>
            </select>
        </div>
        <div class="mb-3">
